                        ...
                        <div
                            ...
                            <a className="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div className="font-weight-bold">
                                    <div className="text-truncate">Hi there! I am wondering if you
                            ...
                            <a className="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div>
                                    <div className="text-truncate">I have the photos that you
                            ...
                            <a className="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div>
                                    <div className="text-truncate">Last month's report looks great,
                                        I am very happy with the progress so far, keep up the good
                                        work!
                                    </div>
                            ...
                            <a className="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div>
                                    <div className="text-truncate">Am I a good boy? The reason I ask
