                                                ...
                                                <div className="card-body">
                                                    <div className="row no-gutters align-items-center">
                                                        <div className="col mr-2">
                                                            ...
                                                            <div className="h5 mb-0 font-weight-bold text-gray-800">18
                                                            </div>
                                                        </div>
                                                        <div className="col-auto">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-8 col-lg-7">
                                            <div className="card shadow mb-4">
                                                ...
                                                <div
                                                    ...
                                                    <h6 className="m-0 font-weight-bold text-primary">Earnings
                                                        Overview</h6>
                                        ...
                                        <div className="col-xl-4 col-lg-5">
                                            <div className="card shadow mb-4">
                                                ...
                                                <div
                                                    className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                    <h6 className="m-0 font-weight-bold text-primary">Revenue
                                                        Sources</h6>
                                                    <div className="dropdown no-arrow">
                                                        <a className="dropdown-toggle" href="#" role="button"
                                                           id="dropdownMenuLink" data-toggle="dropdown"
                                            ...
                                            <div className="card shadow mb-4">
                                                ...
                                                <div className="card-body">
                                                    <p>SB Admin 2 makes extensive use of Bootstrap 4 utility classes in
                                                        ...
                                                        classes.</p>
                                                    <p className="mb-0">Before working with this theme, you should
